export default function makeEnvelope(r1Ele, r2Ele, r3Ele, r4Ele, l1Ele, l2Ele, l3Ele, l4Ele, canvas) {
    let envInputs = {
        "r1": r1Ele,
        "r2": r2Ele,
        "r3": r3Ele,
    ...
    let update = function () {
        ...
        let r1 = parseInt(envInputs.r1);
        let r2 = parseInt(envInputs.r2);
        let r3 = parseInt(envInputs.r3);
        let r4 = parseInt(envInputs.r4);
        let l1 = parseInt(envInputs.l1);
        let l2 = parseInt(envInputs.l2);
        let l3 = parseInt(envInputs.l3);
        let l4 = parseInt(envInputs.l4);
